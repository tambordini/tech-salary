	...
	{#if showModal}
		<div class="modal">
			<div class="modal-content relative">
				...
				<button
					class="absolute bottom-4 right-6 rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600"
					on:click={closeModal}
				>
					ปิด
				</button>
...
<style>
	...
	.modal-content {
		@apply h-[80vh] w-full max-w-3xl rounded-lg bg-white p-6 shadow-lg;
	}
	...
	.benefit-list {
		@apply h-[58vh] overflow-y-auto rounded border border-gray-200 p-4;
	}
</style>
